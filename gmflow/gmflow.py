...
class GMFlow(nn.Module):
    def __init__(self,
        ...
        self.upsampler = nn.Sequential(nn.Conv2d(2 + feature_channels, upsample_hidden_channels, 3, 1, 1),
                                       nn.ReLU(inplace=True),
                                       nn.Conv2d(upsample_hidden_channels, upsample_factor ** 2 * 9, 1, 1, 0))
